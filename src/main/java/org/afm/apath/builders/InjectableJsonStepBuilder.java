...
public class InjectableJsonStepBuilder<JO> extends StepBuilder {
	
   @FunctionalInterface
   interface ValueIterator<JO> { 
       public Object apply (JO jo, String key);
   }
	...
	public InjectableJsonStepBuilder() {
	}
	
	public InjectableJsonStepBuilder(boolean skipArrays) {
